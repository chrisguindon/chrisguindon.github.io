...
These platforms and services support project governance, developer tooling, and day-to-day operations across the Eclipse ecosystem. Much of this infrastructure runs quietly in the background, but it plays a critical role in the health, security, and sustainability of open source projects.
...
One of the roles is a Software Engineer position with a focus on security and detection engineering, alongside general service development and operations.

This role will work on [Open VSX Registry](https://open-vsx.org/), an open source registry for VS Code extensions operated by the Eclipse Foundation. As adoption grows across multiple development environments, maintaining the integrity and trustworthiness of the registry requires continuous analysis, detection, and operational safeguards.
...
For additional context on the problems this role addresses, see my recent post on [strengthening supply-chain security in Open VSX](https://blogs.eclipse.org/post/christopher-guindon/strengthening-supply-chain-security-open-vsx).
...
To apply: \
[https://eclipsefoundation.applytojob.com/apply/mvaSS7T8Ox/Software-Developer](https://eclipsefoundation.applytojob.com/apply/mvaSS7T8Ox/Software-Developer)
